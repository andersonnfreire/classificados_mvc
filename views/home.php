            ...
            <form method="GET">
                ...
                <div class="form-group">
                    ...
                    <select id="preco" name="filtros[preco]" class="form-control">
                        ...
                        <option value="500-100000" <?php echo ($filtros['preco'] == '500-100000') ? 'selected="selected"' : ''; ?>>acima de R$ 500</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="estado" name="filtros[estado]" class="form-control">
                        <option></option>
                        <option value="0" <?php echo ($filtros['estado'] == '1') ? 'selected="selected"' : ''; ?>>Ruim</option>
                        <option value="1" <?php echo ($filtros['estado'] == '2') ? 'selected="selected"' : ''; ?>>Bom</option>
                        <option value="2" <?php echo ($filtros['estado'] == '3') ? 'selected="selected"' : ''; ?>>Ótimo</option>
                    </select>
                </div>
